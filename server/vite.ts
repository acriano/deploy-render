...
export async function setupVite(app: Express, server: Server) {
  ...
  // Importar viteConfig dinamicamente - TEMPORARIAMENTE COMENTADO PARA BUILD
  // const viteConfig = (await import("../client/vite.config.mjs")).default;

  const vite = await createViteServer({
    // ...viteConfig, // TEMPORARIAMENTE COMENTADO PARA BUILD
    configFile: false,
    customLogger: {
      ...viteLogger,
      error: (msg, options) => {
